...
public class TestGameBoardMem {
    ...
    /**
     * Helper function that creates a GameBoardMem object
     ...
     *
     * @post GameBoardMem board [row number of rows, col number of columns, num_win number tokens in a row to win]
     *
     * @return an IGameBoard object
     */
    private IGameBoard makeAGameBoard(int row, int col, int num_win)  {return new GameBoardMem(row, col, num_win);}
